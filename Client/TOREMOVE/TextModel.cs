...
//
//		static  Shader shader = AssetManager.Get<Shader>("SpriteShader");
//		static  Texture texture = AssetManager.Get<Texture>("RotorcapFont");
//		static  float uv_char_width = 1f / chars.Length;
//		IndexBuffer ib;
//
