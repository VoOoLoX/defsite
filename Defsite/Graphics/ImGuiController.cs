...
namespace Defsite {
    public class ImGuiController {
        ...
        System.Numerics.Vector2 scale_factor = System.Numerics.Vector2.One;
        ...
        public void CreateDeviceResources() {
            ...
            vertex_buffer = new VertexBuffer(vertex_buffer_size) {
                Layout = buffer_layout
            };

			index_buffer = new IndexBuffer(index_buffer_size);
        ...
        public void RecreateFontDeviceTexture() {
            ...
            var texture_file = new TextureFile((ushort)width, (ushort)height, pixels, width * height * bytes_per_pixel);
        ...
        internal void PressChar(char key_char) {
            PressedChars.Add(key_char);
        }
        ...
        void RenderImDrawData(ImDrawDataPtr draw_data) {
            ...
            for (var i = 0; i < draw_data.CmdListsCount; i++) {
                ...
                if (vertex_size > vertex_buffer_size) {
                    ...
                    vertex_buffer.SetData(new_size);
            ...
            shader.Enable();
			shader.Set("u_projection_matrix", mvp);
            ...
            for (var n = 0; n < draw_data.CmdListsCount; n++) {
                ...
                vertex_buffer.SetSubData(cmd_list.VtxBuffer.Size * Unsafe.SizeOf<ImDrawVert>(), cmd_list.VtxBuffer.Data);

                index_buffer.SetSubData(cmd_list.IdxBuffer.Size * sizeof(ushort), cmd_list.IdxBuffer.Data);
